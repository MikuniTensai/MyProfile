...
public class MainPertemuan3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_pertemuan3);
        ...
        webView.loadUrl("https://drive.google.com/file/d/14oL1SBacMM3VbsW99ChOP4eLqNtA5oNX/view?usp=sharing");

        WebView webView1 = findViewById(R.id.webview1);
        webView1.getSettings().setJavaScriptEnabled(true);
        webView1.loadUrl("https://drive.google.com/file/d/14ivvmsjkrDC5zjbjGbWy2o4pSOTafGVS/view?usp=sharing");

        button = findViewById(R.id.button);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(MainPertemuan3.this, MainScreen.class);
                startActivity(a);
            }
        });
    }
